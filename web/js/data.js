...
const SLIDES = [
  ...
  /* ---------- 1 · EL PRINCIPIO ---------- */
  {
    ...
    photos: [
      ...
      { src: "media/img/IMG_2235.jpg",
        t: "Empezando a escribirnos",
        d: "Cada mensaje era un mundo por descubrir. Y sin darnos cuenta, ya estábamos escribiendo la mejor historia que existe: la nuestra.",
        note: "hola y hola, y nunca más parar" },
    ],
  },
